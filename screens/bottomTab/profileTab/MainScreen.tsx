...
import { Image, Linking, Platform, StyleSheet, ScrollView, RefreshControl } from "react-native";
...
export default function MainScreen({
    ...
    return (
        <ScrollView
			...
			refreshControl={
				<RefreshControl refreshing={refresh} onRefresh={() => { setRefresh(true);refetch() }} />
			}
        >
            {/* User header */}
            <View
